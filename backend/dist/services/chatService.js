...
class ChatService {
    ...
    async saveChatHistory(userId, userMessage, assistantMessage) {
        try {
            ...
            // Add new messages
            chatHistory.messages.push({ role: 'user', content: userMessage, timestamp: new Date() }, { role: 'assistant', content: assistantMessage, timestamp: new Date() });
